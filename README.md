...
| <a name="input_ecs_allow_privileged_containers"></a> [ecs\_allow\_privileged\_containers](#input\_ecs\_allow\_privileged\_containers) | Whether or not to allow privileged containers, defaults to true | `bool` | `true` | no |
| <a name="input_ecs_enable_spot_instance_draining"></a> [ecs\_enable\_spot\_instance\_draining](#input\_ecs\_enable\_spot\_instance\_draining) | Whether or not to enable spot instance draining, defaults to true | `bool` | `true` | no |
...
| <a name="output_service_discovery_dns_namespace_hosted_zone_id"></a> [service\_discovery\_dns\_namespace\_hosted\_zone\_id](#output\_service\_discovery\_dns\_namespace\_hosted\_zone\_id) | Hosted zone id of the discovery namespace |
